namespace Tanehs.AspNet.Identity.UI.Core.Manager.EntityFramework
{
    ...
    public class ApplicationUserManager : UserManager<User>
    {
        ...
        {
            ApplicationUserStore Store = new ApplicationUserStore(context.Get<ApplicationDbContext>());
            ...
            manager.EmailService = new EmailServiceManager();
            manager.SmsService = new SmsServiceManager();
